...
<%--                </div>--%>
                <div>
                    ...
                    <input type="text" name="product" value="${bill.product}" id="providerName" placeholder="123"/>
                    <span >*</span>
                </div>
<%--                <div>--%>
...
<%--                </div>--%>
                <div>
                    ...
                    <input type="text" name="amount" value="${bill.amount}" id="address" placeholder="200"/>
                    <span>*</span>
                </div>
                <div>
                    <label for="fax">供应商：</label>
                    <input type="text" name="supplier" value="${bill.supplier}" id="fax" placeholder="北大"/>
                    <span>*</span>
                </div>
                <div>
                <label >是否付款：</label>
                <input type="text" name="pay" value="${bill.pay}"
